    ...
    render() {
        return (
            <div style={{ margin: "50px 0px" }}>
                ...
                <div id="order_preview" class="wow fadeInUp container">
                    <div class="row">
                                ...
                                <table class="table table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="badge delete" data-toggle="modal" data-target="#info_popup"
                                                    onClick={this.handleClickOpen}

                                                > <i class="fa fa-external-link"></i> View</a>
                                                <a class='badge del hide' data-toggle="modal" data-target="#myModal"> <i class="fa fa-trash"></i> Delete</a>
                                                <a class='badge red' data-toggle="modal" data-target="#report_popup"
                                        ...
                                        <tr>
                                            <td colspan="6"></td>
                                            <td colspan="3"><p style={{ margin: "10px 0px", fontSize: "14px" }}><strong>Total Amount : 1093$</strong></p></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
