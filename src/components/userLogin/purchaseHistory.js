    ...
    render() {
        return (
            <div style={{ margin: "50px 0px" }}>
                <div id="order_preview" class="container wow fadeInUp ">
                    <div class="row">
                        <div class="col-xs-12 col-md-4">
                            <h3 class="section-title-sub" style={{ textAlign: 'left', padding: "5px 0px" }}>Purchase History</h3>
                        </div>
                        ...
                        <div class="col-xs-12 col-md-12">
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    {this.props.profile.oldHistory.map((item, index)=>{
                                        return <tr>
                                        <td>{index+1}</td>
                                        <td>{item.date}</td>
                                        <td>{item.mints}</td>
...
let mapStateToProps = (store) => {
    console.log('store is working ' + store.AuthReducer);
